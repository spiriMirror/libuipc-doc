...
# Class uipc::constitution::AffineBodyRevoluteJointLimit



[**ClassList**](annotated.md) **>** [**uipc**](namespaceuipc.md) **>** [**constitution**](namespaceuipc_1_1constitution.md) **>** [**AffineBodyRevoluteJointLimit**](classuipc_1_1constitution_1_1AffineBodyRevoluteJointLimit.md)
...
| Type | Name |
| ---: | :--- |
|   | [**AffineBodyRevoluteJointLimit**](#function-affinebodyrevolutejointlimit) (const Json & config=default\_config()) <br> |
...
|   | [**~AffineBodyRevoluteJointLimit**](#function-affinebodyrevolutejointlimit) () override<br> |
...
### function AffineBodyRevoluteJointLimit 

```C++
uipc::constitution::AffineBodyRevoluteJointLimit::AffineBodyRevoluteJointLimit (
...
```C++
void uipc::constitution::AffineBodyRevoluteJointLimit::apply_to (
...
```C++
uipc::constitution::AffineBodyRevoluteJointLimit::~AffineBodyRevoluteJointLimit () override
```
...
```C++
static Json uipc::constitution::AffineBodyRevoluteJointLimit::default_config () 
```
...
------------------------------
The documentation for this class was generated from the following file `include/uipc/constitution/affine_body_revolute_joint_limit.h`
