...
|  std::string\_view | [**InterPrimitive**](#variable-interprimitive)   = `"InterPrimitive"`<br> |
...
|   | [**UIPC\_BUILTIN\_ATTRIBUTE**](#function-uipc_builtin_attribute) (global\_vertex\_offset) <br> |
...
```C++
std::string_view uipc::builtin::InterPrimitive;
```
...
`d_hat` _&lt;Float&gt; attribute on_**meta** _, indicates mesh-wise d\_hat_
```C++
uipc::builtin::UIPC_BUILTIN_ATTRIBUTE (
    d_hat
) 
